...
const product = {
  ...
  stock: 12,
  images: [
    "/pngtree-3d-beauty-cosmetics-product-design-png-image_3350323-removebg-preview.png",
...
const relatedProducts = [
  { id: 2, name: "Skincare Set", price: 65.00, rating: 4.8 },
  { id: 3, name: "Makeup Palette", price: 45.00, rating: 4.6 },
  { id: 4, name: "Beauty Bundle", price: 99.00, rating: 4.7 },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-200 via-pink-200 to-pink-300/90">
      ...
      ">
        <ol className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <li><Link href="/products" className="hover:text-pink-600 transition">Products</Link></li>
          <ChevronRight className="w-4 h-4" />
                ...
                <div className="flex gap-3 justify-center">
                  {product.images.map((img, idx) => (
                    <button
                      ...
                      className={`relative w-20 h-20 rounded-xl overflow-hidden border-2 transition ${selectedImage === idx ? "border-pink-500" : "border-transparent hover:border-pink-300"
                        }`}
                    >
                      <Image
                        src={img}
              ...
              <div className="p-6 lg:p-10 flex flex-col">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {variant.options.map((option) => (
                          <button
                            ...
                            className={`px-4 py-2 rounded-lg border-b border-white transition ${selectedVariants[variant.name] === option
                ...
                <div className="flex gap-3 mb-8">
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 py-4 rounded-xl font-semibold transition ${isAddedToCart
